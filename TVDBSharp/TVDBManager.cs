...
namespace TVDBSharp
{
    ...
    public class TVDBManager : ITVDBManager
    {
        ...
        public TVDBManager(string apiKey, string url = "http://thetvdb.com/api")
        {
            // Api Configuration
        ...
        public async Task<Series> GetSeries(int showId, Language language)
        {
        ...
        /// <returns></returns>
        public async Task<Series> GetFullSeries(int showId, Language language)
        {
        ...
        public async Task<Episode> GetEpisode(int episodeId, Language language)
        {
