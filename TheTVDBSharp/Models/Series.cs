...
namespace TheTVDBSharp.Models
{
    ...
    public class Series : IEquatable<Series>
    {
        ...
        /// </summary>
        public string BannerRemotePath
        {
            get;
            set;
        }
        ...
        /// </summary>
        public string FanartRemotePath
        {
            get;
            set;
        }
        ...
        ///     Let me know if you find out what this is.
        /// </summary>
        public string PosterRemotePath
        {
            get;
            set;
        }
        ...
        /// </summary>
        public IReadOnlyCollection<Episode> Episodes
        {
            get;
            set;
        }

        public IReadOnlyCollection<BannerBase> Banners
        {
            get;
            set;
        }
