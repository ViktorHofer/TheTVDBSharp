...
namespace TheTVDBSharp.Services
{
    public class SeriesParseService : ISeriesParseService
    {
        ...
        {
            _actorParseService = actorParseService ?? throw new ArgumentNullException(nameof(actorParseService));
            _bannerParseService = bannerParseService ?? throw new ArgumentNullException(nameof(bannerParseService));
            _episodeParseService = episodeParseService ?? throw new ArgumentNullException(nameof(episodeParseService));
        }
